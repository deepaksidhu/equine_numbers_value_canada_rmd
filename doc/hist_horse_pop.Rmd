...
There was once a useful paper based on weights [@horses].
...
```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. Horse populations for Alberta between 1940 - 1972.", out.width="70%"}
